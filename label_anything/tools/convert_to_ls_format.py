...
def convert_coco_to_ls(
    ...
    Args:
        ...
        to_name (str, optional): Name of the object tag that provided the
            region to be labeled. Defaults to 'image'.
        use_super_categories (bool, optional): whether to use super_categories
            in COCO. Defaults to False.
        image_root_url (str, optional): Image path prefix.
            Defaults to '/data/local-files/?d='.
    """
    tasks = {}  # image_id => task
