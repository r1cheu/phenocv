...
class ImageEncoderViT(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            global_attn_indexes (list): Indexes for blocks using global
                attention.
        """
        super().__init__()
        ...
        if use_abs_pos:
            # Initialize absolute positional embedding with pretrain
            # image size.
    ...
    def __init__(
        ...
        Args:
            ...
            window_size (int): Window size for window attention blocks. If it
                equals 0, then use global attention.
    ...
    def __init__(
        ...
        Args:
            ...
            qkv_bias (bool):  If True, add a learnable bias to query,
                key, value.
            rel_pos (bool): If True, add relative positional embeddings to
                the attention map.
            rel_pos_zero_init (bool): If True, zero initialize relative
                positional parameters.
            input_size (tuple(int, int) or None): Input resolution for
...
def add_decomposed_rel_pos(
    ...
    Args:
        ...
        q (Tensor): query q in the attention layer with
            shape (B, q_h * q_w, C).
