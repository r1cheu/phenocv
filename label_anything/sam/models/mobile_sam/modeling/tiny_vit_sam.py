...
class BasicLayer(nn.Module):
    ...
    Args:
        ...
        use_checkpoint (bool): Whether to use checkpointing to save memory.
          Default: False.
        local_conv_size: the kernel size of the depthwise convolution between
          attention and MLP. Default: 3
        activation: the activation function. Default: nn.GELU
...
_checkpoint_url_format = \
    'https://github.com/wkcn/TinyViT-model-zoo/releases/download/checkpoints/{}.pth' # noqa
...
def register_tiny_vit_model(fn):
    """Register a TinyViT model It is a wrapper of `register_model` with
    ...
    def fn_wrapper(pretrained=False, **kwargs):
        ...
        if pretrained:
            ...
            assert model_name in _provided_checkpoints, \
                f'Sorry that the checkpoint `{model_name}` is not provided yet.' # noqa
